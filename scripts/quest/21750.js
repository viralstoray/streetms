...
function end(mode, type, selection) {
	...
	if (status == 0) {
		qm.sendNext("Aran...? Are my eyes deceiving me? Is it really you, Aran? You're alive? Oh, thank goodness! Thank you, Aran. Thank you!", 9);
	} else if (status == 1) {
		qm.sendNextPrev("I'm very sorry, but I don't remember you.", 3);
	} else if (status == 2) {
		qm.sendNextPrev("What...? What do you mean? Aran, it's you, isn't it? You're Aran. You're the hero that saved us. Aran, don't you remember?", 9);
	} else if (status == 3) {
		qm.sendNextPrev("#b(You explain the situation as well as you can.)#k", 3);
	} else if (status == 4) {
